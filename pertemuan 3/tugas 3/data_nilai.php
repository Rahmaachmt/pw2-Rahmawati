...
<head>
    ...
    <style>
        ...
        .container {
            max-width: 900px;
            margin: 0 auto;
            background-color: #F7DED0; /* Warna latar dari container diubah ke putih untuk kontras dengan bayangan */
            padding: 20px;
            border-radius: 10px;
        ...
        .btn {
            ...
            color: white;
            background-color: #E2BFB3; /* Merah */
            border: 1px solid transparent;
            border-radius: 4px;
        }

        .btn-danger:hover {
            background-color: #E2BFB3; /* Merah lebih gelap */
        }
    </style>
</head>
<body>
